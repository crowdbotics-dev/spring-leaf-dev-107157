"""
Django settings for spring_leaf_dev_107157 project.
...
ROOT_URLCONF = 'spring_leaf_dev_107157.urls'
...
WSGI_APPLICATION = 'spring_leaf_dev_107157.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_leaf_dev_107157 API",
    "DESCRIPTION": "API documentation for spring_leaf_dev_107157 App",
    "VERSION": "v1",
}
